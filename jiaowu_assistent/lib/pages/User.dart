...
Future<EmptyRoom> getEmptyRoom(
  ...
  try {
    Response response = await Dio().get(
        'http://www.mocky.io/v2/5e9a690133000021bf7b3008',
        options: Options(
            responseType: ResponseType
                .plain)); //http://114.115.208.32:8000/query/classroom/ campus="$campus" date="$date" section="$section"
    print(
        'Request(http://127.0.0.1:8000/query/classroom/ campus="$campus" date="$date" section="$section")');
